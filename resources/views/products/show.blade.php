            ...
            <section class="product my-5">
                    ...
                    <div class="photo-container">
                        <div class="photo-container-content">
                            <div class="photo-main">
                                <div class="controls">
                                    <i class="material-icons"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                    ...
                                    <div id="main-carousel" class="carousel slide" data-bs-ride="carousel">
                                        <div class="carousel-inner">
                                            @foreach ($product->images as $index => $image)
                                                <div id_imagen_carrusel="{{ $index }}"
                                                    class="carousel-item {{ $index == 0 ? 'active' : '' }}">
                                                    <img src="data:image/jpg;base64, {{ $image->base64 }}"
                                                        class="d-block w-100" alt="green apple slice">
                                                </div>
                                            @endforeach
                                        </div>
                            ...
                            <div class="photo-album">
                                <ul>
                                    @foreach ($product->images as $index => $image)
                                        <li><button class="album-btn" id_imagen_album="{{ $index }}"><img
                ...
                <div class="product__info">
                    ...
                    <div class="size">
                        ...
                        <ul>
                            <li><img src="https://w7.pngwing.com/pngs/369/94/png-transparent-strawberry-pie-fruitcake-tart-cheesecake-torte-cake-cream-food-strawberries.png"
                                    alt="green apple"></li>
                            <li><img src="https://w7.pngwing.com/pngs/369/94/png-transparent-strawberry-pie-fruitcake-tart-cheesecake-torte-cake-cream-food-strawberries.png"
                                    alt="yellow apple"></li>
                            <li><img src="https://w7.pngwing.com/pngs/369/94/png-transparent-strawberry-pie-fruitcake-tart-cheesecake-torte-cake-cream-food-strawberries.png"
