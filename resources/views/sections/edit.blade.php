<x-auth-layout>
    <form method="POST" action="{{ route('secciones.update', $section->id) }}">
        @csrf
        @method('PUT')
            ...
            <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                <div class="card" style="border-radius: 15px; padding: 20px">
                    <div class="card-body p-5">
                        <h2 class="text-uppercase text-center text-red mb-5">Editar Sección</h2>
                        @if (session('error'))
                        ...
                        <div data-mdb-input-init class="form-outline mb-2">
                            ...
                            <x-text-input id="name" class="input form-control form-control-lg"
                                ...
                                :value="old('name', $section->name)" required autofocus autocomplete="name" /><x-input-error
