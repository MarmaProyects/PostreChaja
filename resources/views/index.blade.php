<x-guest-layout>
    ...
    <swiper-container class="mySwiper" pagination="true" pagination-clickable="true" space-between="15" slides-per-view="5"
        ...
        @foreach ($products as $index => $product)
            <swiper-slide>
                <a href="{{ route('productos.show', $product->id) }}" class="card-button p-0 m-0 w-100">
    ...
    <div class="row justify-content-between home-presentation mb-5">
        <div class="col">
            ...
            <p class="my-5">Visita nuestra confitería para disfrutar de nuestros exquisitos productos. Ubicados en
                Uruguay, ofrecemos una variedad de dulces que deleitarán tu paladar. Ven y prueba nuestras
                especialidades.</p>
        </div>
        <div class="col">
